  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative grid grid-cols-6 gap-3 rounded-2xl bg-paper/[0.03] backdrop-blur-sm border border-paper/10 p-3 shadow-2xl">
        {/* Risk score */}
        <div className="col-span-6 md:col-span-2 rounded-xl bg-paper p-5">
        ...
        <div className="col-span-6 md:col-span-4 rounded-xl bg-paper p-5">
        ...
        {/* Renewal timeline */}
        <div className="col-span-6 md:col-span-3 rounded-xl bg-paper p-5">
          <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Renewal timeline</div>
          <div className="mt-5 relative">
            <div className="h-1 w-full rounded-full bg-secondary" />
            <div className="absolute top-0 left-0 h-1 rounded-full bg-accent" style={{ width: "62%" }} />
        ...
        <div className="col-span-6 grid grid-cols-2 gap-3">
          <div className="rounded-xl bg-paper p-4 flex items-center gap-3">
          ...
          <div className="rounded-xl bg-paper p-4 flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium text-ink flex items-center gap-2">
                Human review required <AlertCircle className="h-3.5 w-3.5 text-accent" />
              </div>
...
function Pill({ name, priority }: { name: string; priority: "Essential" | "Recommended" | "Consider" }) {
  const tone = priority === "Essential" ? "bg-accent/10 text-accent border-accent/20"
  ...
  return (
    <div className={`flex items-center justify-between rounded-md px-3 py-2 text-xs ${best ? "bg-accent/5 border border-accent/30" : "bg-secondary"}`}>
      <div className="flex items-center gap-2">
        ...
        {best && <span className="text-[9px] uppercase tracking-wider text-accent font-semibold">Best fit</span>}
      </div>
