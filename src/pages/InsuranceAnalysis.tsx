    ...
    <>
      ...
      <section className="bg-navy-deep text-paper relative overflow-hidden">
        ...
        <div className="container-atlas relative py-20 md:py-24">
          <Eyebrow dark>Pistachio · Company Insurance Analysis</Eyebrow>
          ...
          <p className="mt-6 text-lg text-paper/70 max-w-2xl">
            Enter your company details and Pistachio will generate an initial insurance needs and risk
    ...
    <div className="space-y-10">
      ...
      <div className="rounded-2xl bg-navy text-paper p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="relative grid md:grid-cols-12 gap-8 items-start">
          <div className="md:col-span-7">
            <Eyebrow dark>Pistachio · Insurance Analysis Report</Eyebrow>
      ...
      <div className="rounded-2xl border border-border bg-card p-8">
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="outline" onClick={() => toast("Document upload is coming soon.", { description: "Placeholder for Pistachio Risk OS integration." })}>
            <Upload className="h-4 w-4" /> Upload Policy Documents
          </Button>
          <Button variant="outline" onClick={() => toast("Detailed intake placeholder.", { description: "Will route to Pistachio Risk OS." })}>
