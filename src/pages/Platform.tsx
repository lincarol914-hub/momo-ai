  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Three Atlas operating systems — Risk, Growth and Acquire — share a single data, audit and review layer."
      />
        ...
        <div className="container-atlas">
          <div className="rounded-3xl bg-navy text-paper p-10 md:p-14 flex flex-col md:flex-row gap-8 justify-between md:items-end">
            <div>
              ...
              <h2 className="mt-4 font-display text-3xl md:text-4xl text-paper max-w-xl">Run a Company Insurance Analysis powered by Atlas Risk OS.</h2>
            </div>
            <CTARow dark />
          </div>
        </div>
      ...
      <div className="container-atlas">
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            <SectionHeader dark={dark} eyebrow={`Atlas · ${tag}`} title={title} description={body} />
          </div>
        </div>
