  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Atlas helps businesses understand their risks, prepare better insurance information, compare options, and manage policies more efficiently."
      />
      ...
      <section className="section bg-secondary/40">
        <div className="container-atlas">
          <SectionHeader eyebrow="What Atlas helps with" title="A clearer path through commercial insurance." />
      ...
      <section className="section bg-secondary/40">
        <div className="container-atlas">
          <SectionHeader eyebrow="Products we can help review" title="Cover Atlas can help you scope and compare." />
