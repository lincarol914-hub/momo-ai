  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Pistachio partners with and acquires insurance brokers, MGAs and specialist insurance businesses, then supports them with AI-powered operating infrastructure."
      />
      ...
      <section className="section">
        <div className="container-atlas grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            <SectionHeader
              eyebrow="Why broker owners talk to Pistachio"
      ...
      <section className="section">
        <div className="container-atlas grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 text-muted-foreground">All enquiries are handled discreetly by the Pistachio founders. No third-party brokers, no shared data.</p>
            <Disclaimer>Submitting this form does not create any obligation. Pistachio will only contact you with regard to your enquiry.</Disclaimer>
          </div>
...
function SuccessState({ onReset }: { onReset: () => void }) {
  return (
    <div className="rounded-2xl border border-border bg-card p-10 text-center shadow-card">
      ...
      <p className="mt-2 text-muted-foreground">An Pistachio founder will be in touch within two working days, confidentially.</p>
